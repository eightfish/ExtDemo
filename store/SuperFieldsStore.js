...
Ext.define('EvolveQueryEditor.store.SuperFieldsStore', {
    ...
    onArraystoreBeforeLoad: function(store, operation, eOpts) {
        ...
        this.proxy.url = EvolveQueryEditor.model.Query.serverUrlBase + '&method=BringOutSuperfieldFilters';
    }
}, function (Cls) {
    Cls.Instance = Ext.create('EvolveQueryEditor.store.SuperFieldsStore');
});